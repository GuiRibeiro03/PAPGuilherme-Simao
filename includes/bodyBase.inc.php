                ...
                <div class="ht-options">
                    <div class="row">
                        <div class="ht-widget">
                            ...
                            ?>
                            <ul>
                                <li style="float: right; font-size: 20px"><div class="ht-widget"">
                                    <ul class="float-right">
                                        <div class="dropdown" >
                                            </span><a href="#" ><button class="dropdown-toggle" id="btnPerfil"  style="background-color: transparent"><a href="perfilUser.php?id=<?php echo $dados["perfilId"] ?>" ><img src="<?php echo $dados["perfilAvatarURL"] ?>" style="width: 60px; height: 60px; border-radius: 50%; float: left;"></a><span style="margin-left: 10px"></span></button></a>
                                            <div id="perfil" class="dropdown-content" style="background-color: #202020; color: #FFF">
                                                ...
                                                if($dados["userType"]=="admin"){
                                                    ?>
                                                    <li ><a href="backoffice/Backoffice.php"><button type="button" class="btn btn-danger" style="background-color: red; width: 100%;"><span  style="font-family: 'Montserrat', sans-serif; color: #FFFFFF; font-size: 17px; ">Backoffice</span></button></a></li>
                    ...
                    <div class="row">
                        <div class="ht-widget">
                            ...
                            ?>
                                        ...
                                        ?>
                                            <span style="color: #000000!important; font-size: 20px; font-weight: 500; ">Total : <?php echo $total; ?>&nbsp;€</span>
                                        <?php
                                         }
                                        ?>
