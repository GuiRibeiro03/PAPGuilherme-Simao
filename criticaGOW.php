...
?>
    ...
    <section class="details-hero-section set-bg" data-setbg="img/wallpapers/godofwar2.jpg">
        <div class="container">
            <div class="row">

                    <div class="details-hero-text">
                        <div class="label"><span>Análise</span></div>
                        <h1 style="text-shadow: 2px 2px 0px #FF0000;">God of War</h1>
    ...
    <div style="float: right">
        ...
        <video width="620" height="480" controls>
            <source src="Videos/GOW.mp4" type="video/mp4">
            ...
            <div class="row">
                    ...
                    <div class="details-text"  >
                        <div style="color: white">
                            ...
                            <br>
                        <div class="dt-desc">
                            <p style="font-size: 16px">Ser pai é um dos momentos mais transformadores na vida de um homem,
                                daqueles em que olhando para trás, conseguimos definir um claro antes e um depois.
                                A mudança é brusca, mas o que se segue é um processo de aprendizagem que é recíproco.
                                Não sei até que ponto foi Atreus quem fez Kratos desligar-se da vida como Ghost of Sparta,
                                se foi o amor da mãe ou a culpa, quando o reencontramos, está mergulhado num luto tão gélido como o ambiente do jogo,
                                a norte da Europa, incitado apenas pelo cumprimento de uma promessa e responsabilidade que como qualquer pai,
                                sente ter por aquele pequeno rapaz.</p>

                            <p style="font-size: 16px">É difícil compreender como só agora um jogo do cabeça de teia mereceu este nível de investimento,
                                questionamos o que raio andou a fazer a licença até aqui,
                                o certo é que depois da adaptação do segundo filme de Sam Raimi para videojogo,
                                há 14 anos atrás, o aracnídeo viu-se condenado a servir de isca para dinheiro fácil.</p>
                        </div>
                        <div class="dt-overall-rating">
                                    ...
                                    <div class="loader-circle-wrap">
                                        <div class="loader-circle">
                                            ...
                                            <div class="review-point">
                                                <span style="color: #FFFFFF">Critic's Rating:</span>
                            ...
                            <div class="or-qualities">
                                <div class="qualities-item">
                                    <p>The Goods</p>
                                    <ul>
                                        <li><i class="fa fa-check"></i> Machado Levithan.</li>
                                        <li><i class="fa fa-check"></i> Storytelling e a ação contínua.</li>
                                        <li><i class="fa fa-check"></i> Visuais, em especial os modelos das personagens.</li>
                                    </ul>
                                </div>
                                <div class="qualities-item bad-item">
                                    <p>The bads</p>
                                    <ul>
                                        <li><i class="fa fa-close"></i> Quebras de Framerate</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="dt-tags">
                            ...
                            <a href="#"><span id="tag4">Santa Monica Studios</span></a>
                        </div>
                        <div class="dt-share">
                            ...
                            <div class="dt-leave-comment" >
                                ...
                                <span style="font-size: 30px; color: #FFFFFF"> &nbsp;<strong>Deixa a tua opinião:</strong></span>
                                <form action="#" style="padding-top: 20px; margin-left: 20px" >
                                    <div class="input-list" >
                                        <input type="number" placeholder="Rating" maxlength="3" max="100" min="0" style="width: 100px; color: #FFFFFF;">
                                    </div>
