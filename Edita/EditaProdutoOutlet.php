...
<form action="../Confirma/confirmaEditaProdutoOutlet.php?id=<?php echo  $id?>" method="post"  enctype="multipart/form-data" style="color: #FFFFFF; margin: 20px">
    <div class="mb-3">
        <label style="color:white; font-size: 15px; margin-top: 5%" class="badge badge-dark">Nome:</label>
        <input type="text" class="form-control" id="exampleInputEmail1" name="produtoNome" value="<?php echo $dados["produtoNome"]?>">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="produtoPreco" value="<?php echo $dados["produtoPreco"]?>">
    </div>
    <div class="mb-3">
