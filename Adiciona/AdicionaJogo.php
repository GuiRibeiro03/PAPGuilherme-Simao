...
<div style="height: 60px; width: 100%; background-color: red;"><span
            style="padding-left: 40%; font-size: 30px; color: #fff; text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;">Adicionar Novo Jogo</span>
</div>

<section class="store" style="padding:50px">

    <a href="../backoffice/jogosBackoffice.php">
    ...
    <form action="../Confirma/confirmaNovoJogo.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="jogoPreco" style="width: 100px">
        <hr>
