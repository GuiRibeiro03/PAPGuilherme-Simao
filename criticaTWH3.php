...
?>
    ...
    <section class="details-hero-section set-bg" data-setbg="img/wallpapers/thewitcher.jpg">
        <div class="container">
            <div class="row">

                    <div class="details-hero-text">
                        <div class="label"><span>Análise</span></div>
                        <h1 style="text-shadow: 2px 2px 0px #FF0000;">The Witcher 3: Wild Hunt</h1>
                        <ul>
...
<video width="620" height="480" controls>
    <source src="Videos/thewitcher3.mp4" type="video/mp4">
...
<br>
                        <div class="dt-desc">
                            <p style="font-size: 16px">Dos motivos que levam milhões de pessoas a envolverem-se com videojogos, <i> Marvel's Spider-Man</i>  assenta num dos basilares,
                                a possibilidade do cumprimento de uma fantasia, neste caso, a de SER o Homem-Aranha.
                                É um desejo antigo de várias gerações de jogadores, tentado várias vezes com diferentes resultados.</p>
