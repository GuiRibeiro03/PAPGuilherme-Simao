...
?>
        ...
        <a href="AdicionaConsola.php" style="color: #FFFFFF"><button type="button" class="btn btn-success"><i class="fa fa-plus-circle"></i>&nbsp;Adicionar</button></a>
        </td>
        </tr>
        <tr>
            <th>Id</th>
        ...
        <td>399,90€</td>
            ...
            <td><a href="EditaConsola.php" style="color: #FFFFFF"><button type="button" class="btn btn-primary"><i class="fa fa-edit"></i>Editar</button></a></td>
