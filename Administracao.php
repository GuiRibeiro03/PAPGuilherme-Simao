...
<div style="height: 60px; width: 100%; background-color: red;"><span style="padding-left: 41%; font-size: 30px; color: #fff; text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;">Menu Administrativo</span></div>

<section class="store" style="padding:50px">
    <label style="float: left; position: relative" class="badge-pill badge-danger">Jogos</label>
<br>
    <div class="row">
        <div style="color: #FFFFFF" class="col-4">Adicionar Jogo: <a href="AdicionaJogo.php"><button class="btn-danger">Add Jogo</button></a></div>
        <div style="color: #FFFFFF" class="col-4">Editar Jogo: <a href="EditaJogo.php"><button class="btn-danger">Edit Jogo</button></a></div>
